"""
LinnStrument 200 Multi-Mode System
- Keyboard Mode: Scale lighting (row offset 5)
- Drum Mode: 4x4 drum grid + 25-step sequencer (Push-style)
...
class Linnstrument(ControlSurface):
    ...
    def __init__(self, c_instance):
        ...
        self._sequences = [[0 for _ in range(25)] for _ in range(16)]  # 16 pads x 25 steps
    ...
    def _update_drum_leds(self):
        ...
        try:
            ...
            # Top 4 rows: 25-step sequencer (all rows show selected pad's sequence)

...
# Linnstrument 128 uses a 16-column x 8-row grid
# Linnstrument 200 uses a 26-column x 8-row grid
LINNSTRUMENT_COLUMNS = 16  # Set to 26 for Linnstrument 200
LINNSTRUMENT_ROWS = 8
...
class LinnstrumentAbletonMIDI:
    ...
    def set_cell_color(self, column, row, color):
        ...
        self.send_midi([status, 20, column])
